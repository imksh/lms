...
import { Maximize, Minimize, RotateCcw, ChevronLeft, ChevronRight, ChevronUp, ChevronDown } from "lucide-react";

const InteractiveSandbox = ({ defaultCode, theme }) => {
  ...
  return (
    ...
    >
      {/* Left side: Editor */}
      <div className={`flex flex-col h-full bg-base-100 rounded-2xl overflow-hidden transition-all duration-300 ${
      ...
      {/* Right side: Preview */}
      <div className={`flex flex-col bg-base-100 rounded-2xl overflow-hidden transition-all duration-300 ${
        showPreview
